...
## [0.1.2] – Patch Release
  - Поправена структура за публикуване
  - Добавени класификатори и линкове към GitHub
  - Публикувана успешно в PyPI
---
## 📦 Инсталация

FractalNet вече е публикувана в [PyPI](https://pypi.org/project/FractalNet/0.1.2/) и може да бъде инсталирана директно с pip:

```bash
pip install FractalNet==0.1.2
